...
class PostAdmin(admin.ModelAdmin):
  list_display = ("timeline_id", "post_date", "post_text")  # "post_as_json" and "parent_id" # is too big
  search_fields = ("timeline_id", "post_date")
  list_filter = ("timeline_id", "post_date")
